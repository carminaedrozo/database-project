...
/**
 * Base class that represents a query for the 'orderstatus' table.
 *
 *
 *
 * @method     ChildOrderstatusQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildOrderstatusQuery orderByStatus($order = Criteria::ASC) Order by the status column
 *
 * @method     ChildOrderstatusQuery groupById() Group by the id column
 * @method     ChildOrderstatusQuery groupByStatus() Group by the status column
 *
 ...
 * @method     ChildOrderstatus findOneByStatus(string $status) Return the first ChildOrderstatus filtered by the status column *
 ...
 *
 * @method     ChildOrderstatus requireOneById(int $id) Return the first ChildOrderstatus filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOrderstatus requireOneByStatus(string $status) Return the first ChildOrderstatus filtered by the status column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildOrderstatus[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildOrderstatus objects based on current ModelCriteria
 * @method     ChildOrderstatus[]|ObjectCollection findById(int $id) Return ChildOrderstatus objects filtered by the id column
 * @method     ChildOrderstatus[]|ObjectCollection findByStatus(string $status) Return ChildOrderstatus objects filtered by the status column
...
abstract class OrderstatusQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\OrderstatusQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Orderstatus', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, status FROM orderstatus WHERE id = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildOrderstatusQuery The current query, for fluid interface
     */
    ...
    public function filterByStatus($status = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(OrderstatusTableMap::COL_STATUS, $status, $comparison);
    }
