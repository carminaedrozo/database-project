...
abstract class Employee implements ActiveRecordInterface
{
    ...
    public function setRequestId($v)
    {
        ...
        if ($this->aRequest !== null && $this->aRequest->getRequestId() !== $v) {
            $this->aRequest = null;
        }
    ...
    {
        if ($this->aRequest !== null && $this->request_id !== $this->aRequest->getRequestId()) {
            $this->aRequest = null;
        }
    } // ensureConsistency
    ...
    public function getRequest(ConnectionInterface $con = null)
    {
        if ($this->aRequest === null && ($this->request_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aRequest->addEmployees($this);
             */
        }
    ...
    {
        if (null !== $this->aRequest) {
            $this->aRequest->removeEmployee($this);
        }
