...
/**
 * Base class that represents a row from the 'storage' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Storage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\StorageTableMap';
    ...
    /**
     * Compares this with another <code>Storage</code> instance.  If
     * <code>obj</code> is an instance of <code>Storage</code>, delegates to
     * <code>equals(Storage)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Storage The current object, for fluid interface
     */
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStorageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Storage::setDeleted()
     * @see Storage::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStorageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StorageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO storage (%s) VALUES (%s)',
    ...
    {
        $pos = StorageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Storage (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Storage Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(StorageTableMap::DEFAULT_STRING_FORMAT);
    }
