...
/**
 * Base class that represents a row from the 'orderlist' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Orderlist implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OrderlistTableMap';
    ...
    /**
     * Initializes internal state of Base\Orderlist object.
     */
    ...
    /**
     * Compares this with another <code>Orderlist</code> instance.  If
     * <code>obj</code> is an instance of <code>Orderlist</code>, delegates to
     * <code>equals(Orderlist)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Orderlist The current object, for fluid interface
     */
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOrderlistQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Orderlist::setDeleted()
     * @see Orderlist::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOrderlistQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrderlistTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO orderlist (%s) VALUES (%s)',
    ...
    {
        $pos = OrderlistTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Orderlist'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Orderlist (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orderlist Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(OrderlistTableMap::DEFAULT_STRING_FORMAT);
    }
