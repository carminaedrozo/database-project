...
/**
 * Base class that represents a query for the 'storage' table.
 *
 *
 *
 ...
 * @method     ChildStorageQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildStorageQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 ...
 *
 */
abstract class StorageQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Base\StorageQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Storage', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildStorageQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildStorageQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildStorageQuery) {
            return $criteria;
        }
        $query = new ChildStorageQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @param   ChildStorage $storage Object to remove from the list of results
     *
     * @return $this|ChildStorageQuery The current query, for fluid interface
     */
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            StorageTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(StorageTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            StorageTableMap::removeInstanceFromPool($criteria);
