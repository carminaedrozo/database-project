...
abstract class Product implements ActiveRecordInterface
{
    ...
    public function setAuthor($v)
    {
        ...
        if ($this->author !== $v) {
            $this->author = $v;
            $this->modifiedColumns[ProductTableMap::COL_AUTHOR] = true;
        }
    ...
    public function setEdition($v)
    {
        ...
        if ($this->edition !== $v) {
            $this->edition = $v;
            $this->modifiedColumns[ProductTableMap::COL_EDITION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductTableMap::translateFieldName('Author', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_AUTHOR)) {
            $criteria->add(ProductTableMap::COL_AUTHOR, $this->author);
        }
        if ($this->isColumnModified(ProductTableMap::COL_EDITION)) {
