 ...
 * @method     ChildPublisherQuery orderByPhoneNumber($order = Criteria::ASC) Order by the phone_number column
 * @method     ChildPublisherQuery orderByAddress($order = Criteria::ASC) Order by the address column
 * @method     ChildPublisherQuery orderByCity($order = Criteria::ASC) Order by the city column
 * @method     ChildPublisherQuery orderByState($order = Criteria::ASC) Order by the state column
 * @method     ChildPublisherQuery orderByZip($order = Criteria::ASC) Order by the zip column
 *
 ...
 * @method     ChildPublisherQuery groupByPhoneNumber() Group by the phone_number column
 * @method     ChildPublisherQuery groupByAddress() Group by the address column
 * @method     ChildPublisherQuery groupByCity() Group by the city column
 * @method     ChildPublisherQuery groupByState() Group by the state column
 * @method     ChildPublisherQuery groupByZip() Group by the zip column
 *
 ...
 * @method     ChildPublisher findOneByPhoneNumber(string $phone_number) Return the first ChildPublisher filtered by the phone_number column
 * @method     ChildPublisher findOneByAddress(string $address) Return the first ChildPublisher filtered by the address column
 * @method     ChildPublisher findOneByCity(string $city) Return the first ChildPublisher filtered by the city column
 * @method     ChildPublisher findOneByState(string $state) Return the first ChildPublisher filtered by the state column
 * @method     ChildPublisher findOneByZip(string $zip) Return the first ChildPublisher filtered by the zip column *
 ...
 * @method     ChildPublisher requireOneByPhoneNumber(string $phone_number) Return the first ChildPublisher filtered by the phone_number column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPublisher requireOneByAddress(string $address) Return the first ChildPublisher filtered by the address column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPublisher requireOneByCity(string $city) Return the first ChildPublisher filtered by the city column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPublisher requireOneByState(string $state) Return the first ChildPublisher filtered by the state column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPublisher requireOneByZip(string $zip) Return the first ChildPublisher filtered by the zip column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPublisher[]|ObjectCollection findByPhoneNumber(string $phone_number) Return ChildPublisher objects filtered by the phone_number column
 * @method     ChildPublisher[]|ObjectCollection findByAddress(string $address) Return ChildPublisher objects filtered by the address column
 * @method     ChildPublisher[]|ObjectCollection findByCity(string $city) Return ChildPublisher objects filtered by the city column
 * @method     ChildPublisher[]|ObjectCollection findByState(string $state) Return ChildPublisher objects filtered by the state column
 * @method     ChildPublisher[]|ObjectCollection findByZip(string $zip) Return ChildPublisher objects filtered by the zip column
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, phone_number, address, city, state, zip FROM publisher WHERE id = :p0';
        try {
    ...
    public function filterByPhoneNumber($phoneNumber = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PublisherTableMap::COL_PHONE_NUMBER, $phoneNumber, $comparison);
    }
    ...
    public function filterByAddress($address = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PublisherTableMap::COL_ADDRESS, $address, $comparison);
    }
    ...
    public function filterByCity($city = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PublisherTableMap::COL_CITY, $city, $comparison);
    }
    ...
    public function filterByState($state = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PublisherTableMap::COL_STATE, $state, $comparison);
    }
    ...
    public function filterByZip($zip = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PublisherTableMap::COL_ZIP, $zip, $comparison);
    }
