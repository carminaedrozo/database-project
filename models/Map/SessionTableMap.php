...
class SessionTableMap extends TableMap
{
    ...
    /**
     * the column name for the Session_IP field
     */
    const COL_SESSION_IP = 'session.Session_IP';

    /**
     * the column name for the Session_State field
     */
    const COL_SESSION_STATE = 'session.Session_State';

    /**
     * the column name for the Session_Time field
     */
    const COL_SESSION_TIME = 'session.Session_Time';

    /**
     * the column name for the User_Login field
     */
    const COL_USER_LOGIN = 'session.User_Login';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('SessionId', 'SessionIp', 'SessionState', 'SessionTime', 'UserLogin', ),
        self::TYPE_CAMELNAME     => array('sessionId', 'sessionIp', 'sessionState', 'sessionTime', 'userLogin', ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_SESSION_ID, SessionTableMap::COL_SESSION_IP, SessionTableMap::COL_SESSION_STATE, SessionTableMap::COL_SESSION_TIME, SessionTableMap::COL_USER_LOGIN, ),
        self::TYPE_FIELDNAME     => array('Session_ID', 'Session_IP', 'Session_State', 'Session_Time', 'User_Login', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('SessionId' => 0, 'SessionIp' => 1, 'SessionState' => 2, 'SessionTime' => 3, 'UserLogin' => 4, ),
        self::TYPE_CAMELNAME     => array('sessionId' => 0, 'sessionIp' => 1, 'sessionState' => 2, 'sessionTime' => 3, 'userLogin' => 4, ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_SESSION_ID => 0, SessionTableMap::COL_SESSION_IP => 1, SessionTableMap::COL_SESSION_STATE => 2, SessionTableMap::COL_SESSION_TIME => 3, SessionTableMap::COL_USER_LOGIN => 4, ),
        self::TYPE_FIELDNAME     => array('Session_ID' => 0, 'Session_IP' => 1, 'Session_State' => 2, 'Session_Time' => 3, 'User_Login' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('Session_ID', 'SessionId', 'VARCHAR', true, 16, null);
        $this->addColumn('Session_IP', 'SessionIp', 'LONGVARCHAR', true, null, null);
        $this->addColumn('Session_State', 'SessionState', 'VARCHAR', true, 3, null);
        $this->addColumn('Session_Time', 'SessionTime', 'TIMESTAMP', true, null, 'CURRENT_TIMESTAMP');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionTableMap::COL_SESSION_IP);
            $criteria->addSelectColumn(SessionTableMap::COL_SESSION_STATE);
            $criteria->addSelectColumn(SessionTableMap::COL_SESSION_TIME);
            $criteria->addSelectColumn(SessionTableMap::COL_USER_LOGIN);
        } else {
            $criteria->addSelectColumn($alias . '.Session_ID');
            $criteria->addSelectColumn($alias . '.Session_IP');
            $criteria->addSelectColumn($alias . '.Session_State');
